...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String BodyP = JOptionPane.showInputDialog("Name a body part");
		...
		JOptionPane.showMessageDialog(null, "Piranhas are more " + Adj + " during the day, so cross the river at night. \n " +
				"Piranhas are attracted to fresh " + Liquid + " and will most likely take a bite out of your " + BodyP + " if you " + Verb + ". \n" +
